...
/**
 * ErrorComponent - used for displaying error message
 */
export function ErrorComponent(props: Readonly<ErrorProps>) {
  return (
    <div className='container'>
      <Card className='p-3 d-flex flex-row justify-content-around align-items-center'>
        <div className={styles['message-box']}>
          <h1>Oops!</h1>
          <h2>Something went wrong.</h2>
          <p>Message: {props.message}</p>
          <Button>
            <NavLink href='/'><ArrowLeft className="pr-2" size={24} />Go Home</NavLink>
          </Button>
        </div>
        <div>
